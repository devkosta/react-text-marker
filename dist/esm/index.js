...
var MarkedText = function (_a) {
    var textToMark = _a.textToMark, _b = _a.isCaseSensitive, isCaseSensitive = _b === void 0 ? false : _b, markedWords = _a.markedWords, markerColor = _a.markerColor;
    var markElement = "<mark style='background-color: ".concat(markerColor, "'>$&</mark>");
    var reFlag = "g".concat(isCaseSensitive ? '' : 'i');
    markedWords.forEach(function (word) {
        var re = new RegExp(word, reFlag);
        textToMark = textToMark.replace(re, markElement);
    });
    return React.createElement("span", { dangerouslySetInnerHTML: { __html: textToMark } });
};
